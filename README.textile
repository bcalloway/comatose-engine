...
*Note:*
AASM and Role-based authorization are not currently implemented, however the database columns are present if you would like to use those systems.  For an example application currently using this, check out "http://github.com/scullygroup/scully-rails-template":http://github.com/scullygroup/scully-rails-template
