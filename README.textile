...
* Comatose-Rake-n-Bake, to autogenerate page structure based on Freemind Mind Map, "git://github.com/scullygroup/Comatose-Rake-n-Bake.git":git://github.com/scullygroup/Comatose-Rake-n-Bake.git
